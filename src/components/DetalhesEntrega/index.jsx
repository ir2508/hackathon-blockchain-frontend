...
const DetalhesEntrega = ({ carga }) => {
    ...
    return (
        <form>
            ...
            <Input label="ID do caminhão" type="text" id="idCarga" obrigatorio={true} value={carga.detalhesEntrega[0].placaCaminhao} disabled={true} />
            <Input label="Tipo" type="text" id="idCarga" obrigatorio={true} value={carga.detalhesEntrega[0].tipoEntrega} disabled={true} />
