...
const GraficoTemperatura = ({ afericoes, id, status }) => {
    const labels = afericoes.map((a) => format(new Date(a.timestamp * 1000), "dd/MM/yyyy HH:mm"))
    ...
    return (
        <div style={{ width: "100%", maxWidth: "600px", height: "200px" }}>
            <Line
                ...
                options={{
                    ...options,
                    maintainAspectRatio: false, // necessário para respeitar a altura do container
                }}
            />
        </div>
    )
